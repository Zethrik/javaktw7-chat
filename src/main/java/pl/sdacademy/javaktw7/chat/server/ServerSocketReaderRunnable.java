        ...
        if (isRegistered) {
            try (ObjectInputStream inputStream =
                ...
                while (isRunning) {
                    ...
                    } else if ("error".equalsIgnoreCase(message.getMessage())) {
                        isRunning = false;
                    } else {
                ...
                System.out.println("### Someone tried to send a message, but it failed. "
                        + e.getMessage());
            } catch (ClassNotFoundException e) {
                System.out.println("### Received message in unknown format: "
                        + e.getMessage());
            }
